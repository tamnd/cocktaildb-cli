...
Most of these come down to network reality or how cocktaildb serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cocktaildb rate-limits like any public site. cocktaildb already paces
...
Where a surface is gated, cocktaildb reads a cookie or token you supply
...
`cocktaildb`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cocktaildb actually did
