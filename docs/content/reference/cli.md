...
```
cocktaildb <command> [arguments] [flags]
```

Run `cocktaildb <command> --help` for the full flag list on any command. This
...
per operation you declare in `cocktaildb/domain.go`.
