...
// HTTP behaviour is covered in cocktaildb_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "cocktaildb://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("cocktaildb", "about")
	if err != nil || got.String() != "cocktaildb://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want cocktaildb://page/about", got.String(), err)
	}
}
